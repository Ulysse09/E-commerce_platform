...
<body>
    ...
    <form action="" method="post">
        <div class="form-outline mb-4">
            <input type="submit" value="Delete category" name="delete_category" class="form-control w-50 m-auto">
        </div>
        <div class="form-outline mb-4">
            <input type="submit" value="Don't delete category" name="dont_delete" class="form-control w-50 m-auto">
        </div>
    </form>
    <?php
